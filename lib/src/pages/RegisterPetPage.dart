...
class RegisterPetPage extends StatefulWidget {
  @override
  RegisterPetPageState createState() => new RegisterPetPageState();
}
                      ...
                      child: Column(
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              "Not Any Pets Found for Verify Registration.",
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return GestureDetector(
                        onTap: () {
                          ...
                          var docId = listdata?[index]["mainDocFormResponse"]
                              ["doc_form_id"];
