...
class NewRegistrationPage extends StatefulWidget {
  @override
  NewRegistrationPageState createState() => new NewRegistrationPageState();
}
...
class NewRegistrationPageState extends State<NewRegistrationPage>
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                ...
                margin: const EdgeInsets.only(left: 10.0, top: 15, right: 10),
                child: TextField(
                  controller: petname,
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(color: Colors.black87, width: 0),
                          ),
                          child: Padding(
                            padding:
                    ...
                    IconButton(
                      ...
                      onPressed: () async {
                        ...
                        if (date != null) {
                          ...
                          vaccinationnextdate.text = formatter.format(newDate);
                        }
                      },
                    ),
                  ],
                  ...
                  child: AnimatedButton(
                    ...
                    pressEvent: () async {
                      if (petname.text.isEmpty) {
                        ...
                        AnimatedToast("Please Select Breed");
                      } else if (dogageyear == null || dogagemonth == null) {
                        AnimatedToast("Please Select Pet Age");
                      } else if ((isneutering == true || dogmonth == true) &&
                          isNeutering == "") {
                        AnimatedToast("Please Select Neutering Status");
                        // } else if (vaccinationdate.text.toString() == "Please Select Date") {
                        ...
                        AnimatedToast("Please Owner Name");
                      } else if (ownermobileno.text.isEmpty) {
                        AnimatedToast("Please Owner Mobile Number");
                        ...
                        AnimatedToast("Please Enter House/Flat/Plot Number");
                      } else if (AddreetypeValue == "Residence" &&
                      ...
                      }else if ((vaccinationdate.text.toString() != "Please Select Date") && (_vaccinationimage == null)) {
                        AnimatedToast("Please Upload Pet Vaccination Book");
                      }else if ((vaccinationdate.text.toString() == "Please Select Date") && (_vaccinationimage != null)) {
                        AnimatedToast("Please Select Vaccination Date");
                        // } else if (_vaccinationimage == null) {
                        //   AnimatedToast("Please Upload Pet Vaccination");
                      }else if (!checked) {
                        AnimatedToast("Please accept Terms & Conditions.");
                      } else {
                        showdialog(context);
                        NewRegistrationFormAPI();
                      }
                    },
                  ),
                ),
  ...
  void NewRegistrationFormAPI() async {
  ...
  Future<http.Response> registrationform(
    ...
    return http.post(
      Uri.parse(ROOT + NewRegistrationForm),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
        'Token': Token,
      },
  ...
  Future<String> uploadImage_full(filename1, filename2, filename3, filename4,
  ...
  Future<String> uploadImage(filename1, filename2, filename3, filename4,
      filename5, filename6, filename7) async {
    var request =
        http.MultipartRequest('POST', Uri.parse(ROOT + NewRegisterDocument));
    request.fields['formId'] = formId;
    request.files.add(await http.MultipartFile.fromPath('pet1', filename1));
    ...
    if (response.statusCode == 200) {
      ...
      if (amount == "0") {
        ...
        Dialogs.bottomMaterialDialog(
            msg:
                'Cards(credit/debit) payment option is currently unavailable. Please use UPI option to complete this transaction.',
            msgStyle: const TextStyle(color: Colors.black54),
            title: 'Payment Option',
            context: context,
            actions: [
