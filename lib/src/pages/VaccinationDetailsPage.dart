...
class VaccinationDetailsPage extends StatefulWidget {
  String formId;
  VaccinationDetailsPage(this.formId);

  @override
  VaccinationDetailsPageState createState() =>
      new VaccinationDetailsPageState();
}

class VaccinationDetailsPageState extends State<VaccinationDetailsPage> {
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    // doctorid == "DOC_112233"
                                    //     ? doctorlist.elementAt(0)['address']
                                    //     : doctorid == "DOC_112244"
                                    //         ? doctorlist.elementAt(1)['address']
                                    //         : doctorid == "DOC_112255"
                                    //             ? doctorlist
                                    //                 .elementAt(2)['address']
                                    //             : "",
  ...
  void AppointmentAPI() async {
    http.Response response = await appointment(doctorid, widget.formId,
        vaccinationdate.text, mobilenumber, slottingTime);
    print(response.body);
    if (response.statusCode == 200) {
      var data = jsonDecode(response.body.toString());
      Navigator.of(context, rootNavigator: true).pop();
      ...
      AwesomeDialog(
          ...
          desc: 'Your Pet Vaccination Appointment Successfully Register.',
          btnOkOnPress: () {
      ...
      AwesomeDialog(
        ...
        btnCancelColor: MyColors.yellow,
  ...
  Future<http.Response> appointment(String doctorId, String formId,
      String appointmentDate, String mobileNumber, String slottingtime) {
    return http.post(
      Uri.parse(ROOT + VaccinationAppointment),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
        'Token': Token,
      },
